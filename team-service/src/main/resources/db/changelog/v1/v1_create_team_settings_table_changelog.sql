...
CREATE TABLE team_settings (
    ...
    total_storage_limit BIGINT NOT NULL DEFAULT 10000000000 CHECK(total_storage_limit BETWEEN 1 AND 1000000000000),
    max_users INT NOT NULL DEFAULT 10 CHECK(max_users BETWEEN 1 AND 1000),
    max_file_size BIGINT NOT NULL DEFAULT 1000000000 CHECK(max_file_size BETWEEN 1 AND 10000000000),
